...
public:
	...
	virtual void SetJsExceptionRaisedCallback(std::function<void(const char*, const FString&)> Callback) = 0;
	virtual void GetHeapStatistics(FJsHeapStatistics& Out) = 0;
...
public:
	...
	void SetJsExceptionRaisedCallback(std::function<void(const char*, const FString&)> Callback);
	void GetHeapStatistics(FJsHeapStatistics& Out);
